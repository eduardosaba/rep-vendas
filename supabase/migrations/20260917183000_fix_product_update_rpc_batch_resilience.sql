-- Migration: Fix RPC apply_product_update_batch false conflicts and improve update resilience
-- Date: 2026-09-17
...
BEGIN
  ...
  IF jsonb_array_length(p_rows) > 500 THEN
    RAISE EXCEPTION 'Lote excede limite de 500 itens';
  END IF;
  ...
  FOR v_row IN SELECT * FROM jsonb_array_elements(p_rows) LOOP
    ...
    -- Resilient Update: Se o valor atual for idêntico ao novo valor, marca como unchanged.
    -- Caso contrário, efetua o update diretamente sem falso conflito de tipo de número.
