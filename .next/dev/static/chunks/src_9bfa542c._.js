...
function Favorites() {
    ...
    const loadFavoriteProducts = async ()=>{
        const { data: products } = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$supabaseClient$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["supabase"].from("products").select("*").in("id", Array.from(favorites));
        setFavoriteProducts(products || []);
        setLoading(false);
    };
    const loadSettings = async ()=>{
        const { data: sets } = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$supabaseClient$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["supabase"].from("settings").select("*").limit(1);
...
_s(Favorites, "KCDaBNsR42vVHjAnexG6eW6bVsA=", false, function() {
    return [
...
//# sourceMappingURL=src_9bfa542c._.js.map