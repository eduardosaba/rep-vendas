...
function Checkout() {
    ...
    const loadCartItems = async ()=>{
        ...
        const { data: products } = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$supabaseClient$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["supabase"].from('products').select('*').in('id', productIds);
        if (products) {
    ...
    const handleSubmit = async (e)=>{
        ...
        try {
            ...
            const { error: itemsError } = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$supabaseClient$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["supabase"].from('order_items').insert(orderItemsData);
...
_s(Checkout, "2k21VmVlDQ2lAAvZ3BSgqm8kKm4=", false, function() {
    return [
...
//# sourceMappingURL=src_e4a9b137._.js.map