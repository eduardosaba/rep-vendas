...
function OrdersManagement() {
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f2e$pnpm$2f$next$40$16$2e$0$2e$2_$40$babel$2b$core$40$7$2e$2_ac612d167d9caedc69b237559ab43d82$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "OrdersManagement.useEffect": ()=>{
            const getUser = {
                "OrdersManagement.useEffect.getUser": async ()=>{
            ...
            }["OrdersManagement.useEffect.getUser"];
            getUser();
        }
    }["OrdersManagement.useEffect"], [
        router
    ...
    const loadOrders = async (userId)=>{
        setLoading(true);
        try {
            const { data, error } = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$supabaseClient$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["supabase"].from("orders").select(`
          *,
    ...
    const handleEditSave = async ()=>{
        ...
        try {
            const { error } = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$supabaseClient$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["supabase"].from("orders").update({
...
_s(OrdersManagement, "BUwMhyfeEaKSh7+s0zWyVLvgahY=", false, function() {
    return [
...
//# sourceMappingURL=src_fd853ed3._.js.map