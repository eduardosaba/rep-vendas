        ...
        <table className="w-full text-sm">
          <thead className="bg-gray-50">
            <tr>
              ...
              <th className="p-3 text-left">Fonte de Clonagem (Matriz)</th>
            ...
            {loading ? (
              ...
              filtered.map((item) => (
                <tr key={item.user_id} className="border-t">
                  ...
                  <td className="p-3">
                    <button
                      onClick={() => toggleSource(item.user_id, !!item.can_be_clone_source)}
                      title="Ativa ou desativa este catálogo como modelo matriz para clonagem por outros representantes"
                    ...
                    >
                      ...
                      <span className="text-xs font-bold uppercase tracking-tighter">
                        {item.can_be_clone_source ? 'Fonte Matriz' : 'Não é Fonte'}
                      </span>
                    </button>
                  </td>
