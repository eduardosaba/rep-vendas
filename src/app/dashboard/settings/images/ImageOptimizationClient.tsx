...
export default function ImageOptimizationClient() {
        ...
        <div className="bg-white dark:bg-slate-900 p-4 rounded-xl border border-gray-200 dark:border-slate-800 mb-6">
          <div className="flex flex-wrap gap-3">
            <button
              ...
              className="flex items-center gap-2 px-4 py-2 bg-blue-600 text-white dark:text-white rounded-lg font-medium hover:bg-blue-700 hover:opacity-90 active:scale-95 disabled:opacity-50 disabled:cursor-not-allowed transition-all cursor-pointer shadow-sm"
            >
              {isScanning ? (
