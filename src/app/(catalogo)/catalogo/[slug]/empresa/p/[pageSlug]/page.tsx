...
export default async function CompanyCustomPage({ params }: { params: Promise<ParamsType> }) {
  ...
  const { data: publicCatalog } = await supabase
    ...
    .select('user_id,show_top_benefit_bar,top_benefit_text,top_benefit_mode,top_benefit_speed,top_benefit_animation,top_benefit_bg_color,top_benefit_text_color,top_benefit_height,top_benefit_text_size')
  ...
  return (
    ...
    >
      <main className="min-h-screen bg-gray-50 flex flex-col pt-36 md:pt-44">
        <HeaderDistribuidora
        ...
        />
        <section className="w-full px-4 md:px-8 py-8 md:py-12 flex-1">
          <div className="rounded-2xl border border-slate-200 bg-white p-6 md:p-8 shadow-sm w-full max-w-none">
