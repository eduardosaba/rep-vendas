-- Script para inserir marcas de exemplo
...
BEGIN
    ...
    RAISE NOTICE 'Inserindo marcas de exemplo para o usuário: %', my_user_id;
    ...
    RAISE NOTICE 'Marcas de exemplo inseridas com sucesso!';
